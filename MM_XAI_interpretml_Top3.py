...
eeg_all_df.columns = eeg_all_df.columns.str.replace("EEG", "").str.strip()
eeg_all_df.head()
...
# #### Number of instances of '1' ans '2'
...
# ## PART 1: Consider Top channel (Fp1)

# In[36]:


# Split the dataset into features (X) and labels (y)
X = eeg_all_df_float[['Fp1', 'F7', 'F3']]
...
print(classification_report(y_test, y_pred_ebm, zero_division=0))
...
print("The time of execution of above program for top 3 channels is :", (end-start))
